...
import com.retail.shoping.productservice.controller.QueryDSLController;
...
public class ProductControllerTestCase extends TestBase {

    @InjectMocks
    QueryDSLController queryDSLController;
    ...
    void getProductByText() {
        ...
        List<ProductEs> prodElastic = queryDSLController.doMultimatchQuery("Shorts");
    ...
    void getProductByPriceRange() {
        ...
        List<ProductEs> prodElastic = queryDSLController.getProductSearchByPrice(1100, 1200);
        Mockito.verify(queryDSLService.searchByPriceRange(1100, 1200));
        MatcherAssert.assertThat(prodElastic.size(), Matchers.is(Matchers.greaterThanOrEqualTo(1)));
