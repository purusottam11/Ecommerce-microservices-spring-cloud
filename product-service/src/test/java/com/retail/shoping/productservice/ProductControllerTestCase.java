...
import com.retail.shoping.productservice.controller.SearchController;
...
public class ProductControllerTestCase extends TestBase {
    ...
    @InjectMocks
    SearchController queryDSLController;
    ...
    void getProductByPriceRange() {
        ...
        List<ProductElasticSearch> prodElastic = queryDSLController.getProductSearchByPrice(1100, 1200);
